...
const FooterBanner = () => {
  return (
    <div className="flex flex-col xl:flex-row xl:justify-between items-center bg-dark-purple xl:px-14 px-4 xl:h-[406px] h-[436px] rounded-3xl mb-28 relative">
      ...
      <div className=" w-full flex items-center xl:justify-end justify-center xl:translate-y-14.75 translate-y-8.25 relative">
        <img src={cloud} alt="" width={140} height={136} className="absolute xl:static left-8 -top-4 xl:w-[140px] xl:h-[136px] w-18 h-18" />
