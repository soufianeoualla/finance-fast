...
// Complete list of countries with flags, names, and dial codes
const countries = [
  ...
  { code: "DO", name: "Dominican Republic", flag: "🇩🇴", dialCode: "+1849" },
  ...
  { code: "PR", name: "Puerto Rico", flag: "🇵🇷", dialCode: "+1939" },
...
export function PhoneInput({ onValueChange, ...props }: PhoneInputProps) {
  ...
  const formatPhoneNumber = (value: string) => {
    ...
    // Basic formatting - this could be enhanced with country-specific formatting
    if (digits.length <= 3) {
      return digits;
